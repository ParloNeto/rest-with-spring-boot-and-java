...
public class PersonControllerYamlTest {
    ...
    public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/914\""));
        assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/202\""));
